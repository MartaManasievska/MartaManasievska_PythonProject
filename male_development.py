...
class MaleDevelopmentScene(BaseDevelopmentScene):
    def __init__(self, screen):
        super().__init__(screen)
        self.fade_in_done = False

        self.current_outfit_path = os.path.join("character_images", "default_male.png")
    ...
    def render_scene(self):
        ...
        buttons = [
            (os.path.join("buttons", "button_outfit_1.png"), os.path.join("character_images", "male_outfit_1.png")),
            (os.path.join("buttons", "button_outfit_2.png"), os.path.join("character_images", "male_outfit_2.png")),
            (os.path.join("buttons", "button_outfit_3.png"), os.path.join("character_images", "male_outfit_3.png")),
            (os.path.join("buttons", "button_outfit_4.png"), os.path.join("character_images", "male_outfit_4.png")),
            (os.path.join("buttons", "button_outfit_5.png"), os.path.join("character_images", "male_outfit_5.png")),
        ]
